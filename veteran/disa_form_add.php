                                    ...
                                    <div class="buy-sell-widget">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="REQ_DISA_DATE" id="REQ_DISA_DATE" class="form-control" value="<?php echo date('d/m/Y', strtotime('+543 year')) ?>" style="background-color: #31383c;" readonly>
                                            </div>
                                        </div>
