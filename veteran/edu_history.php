...
<head>
    ...
    <title>ประวัติการให้การสงเคราะห์เงินช่วยการศึกษาบุตร </title>
    <!-- Favicon icon -->
    ...
    <th width='10%'>เลขใบคำร้อง</th>
      ...
      <th width='8%'>ดูรายละเอียด</th>
                        ...
                        while ($row = $db->getData()) {
                            ...
                            echo "<td><a href='edu_view.php?&REQ_EDU_ID=".$row['REQ_EDU_ID']."' class='btn btn-primary mt-3 waves-effect'>ดูรายการ</a> 
    <br></br>
