...
echo $_SESSION["m_id"];
$db = new DB;
$ID = $_GET['REQ_MOTHLY_ID'];


$sql = "SELECT * FROM req_monthly as rmoth
INNER JOIN tbl_member as m ON m.m_id = rmoth.m_id 
INNER JOIN tbl_status as st ON st.s_id = rmoth.s_id
INNER JOIN  veteran ON m.m_id = veteran.m_id
WHERE REQ_MOTHLY_ID=$ID AND veteran.VT_ALIVE <>0";
                                        ...
                                        <div class="buyer-info">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <h5>อาชีพ <?php echo $res2['VT_OCCU']; ?> </h5>
                                                    <h5>รายได้ <?php echo $res2['VT_INCOME']; ?> </h5>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>เงินบำนาญปกติ</td>
                                                    <td><?php
                                                            $NORMAL_PENSION_ST = $res["NORMAL_PENSION_ST"];
                                                            if ($NORMAL_PENSION_ST == 1) {
                                                                echo '<font color="#3CE778">';
                                                                echo 'ได้รับเงินบำนาญปกติ ' .$res['NORMAL_PENSION_VALUE'] ."บาท";
                                                                echo '</font>';
                                                            } else if($NORMAL_PENSION_ST == 0) {
                                                                echo '<font color="#FFC300 ">';
                                                                echo 'ไม่ได้รับเงินบำนาญปกติ';
                                                                echo '</font>';
                                                            }
                                                            ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>เงินบำนาญพิเศษ</td>
                                                    <td><?php
                                                            $EXTRA_PENSION_ST = $res["EXTRA_PENSION_ST"];
                                                            if ($EXTRA_PENSION_ST == 1) {
                                                                echo '<font color="#3CE778">';
                                                                echo 'ได้รับเงินบำนาญพิเศษ ' .$res['EXTRA_PENSION_VALUE'] ."บาท";
                                                                echo '</font>';
                                                            } else if($EXTRA_PENSION_ST == 0) {
                                                                echo '<font color="#FFC300 ">';
                                                                echo 'ไม่ได้รับเงินบำนาญพิเศษ';
                                                                echo '</font>';
                                                            }
                                                            ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>เงินครองชีพ</td>
                                                    <td><?php
                                                            $CLIVE_ST = $res["CLIVE_ST"];
                                                            if ($CLIVE_ST == 1) {
                                                                echo '<font color="#3CE778">';
                                                                echo 'ได้รับเงินครองชีพ ' .$res['CLIVE_VALUE'] ."บาท";
                                                                echo '</font>';
                                                            } else if($CLIVE_ST == 0) {
                                                                echo '<font color="#FFC300 ">';
                                                                echo 'ไม่ได้เงินครองชีพ';
                                                                echo '</font>';
                                                            }
                                                            ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>หมายเหตุ</td>
                                                    <td><?php echo $res['REQ_MONTHLY_REMARK']; ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php
                                                        $REQ_HEL_PAY_TYPE = $res["REQ_MONTLY_PAY_TYPE"];
                                                        if ($REQ_MONTLY_PAY_TYPE == 1) {
                                                ...
                                                <tr>
                                                    <td>ไฟล์แนบ</td>
                                                    <td> <?php
                                                            $sql3 = "SELECT file_name, is_image FROM multi_file where m_id = " . $res['m_id'] . " and vs_id ='6'and req_id= " . $res['REQ_MOTHLY_ID'] . "";
