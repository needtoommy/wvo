                    ...
                    <div class="col-md-12">
                        <div class="panel panel-inverse">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="assign_em_search_db.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="REQ_DISA_DATE_FROM" required class="form-control" class="form-control" id="REQ_DISA_DATE_FROM" value="<?php echo date('d/m/Y', strtotime('+543 year')) ?>" placeholder="วัน/เดือน/ปี">
                                        </div>

                                        <div class="col-md-4">
                                            <label class="mr-sm-2">วันที่สิ้นสุดประสบภัยพิบัติ</label>
                                            <input type="text" name="REQ_DISA_DATE_TO" id="REQ_DISA_DATE_TO" required class="form-control" value="" placeholder="วัน/เดือน/ปี">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="REQ_DST_ID" class="form-control" required>
                                                ...
                                                while ($res2 = $db->getData()) { ?>
                                                    <option value="<?php echo $res2["DST_ID"]; ?>">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="REQ_DMT_TYPE" class="form-control" required>
                                                <option value="">เลือกข้อมูล</option>
                                                <option value="ที่อยู่อาศัย">ที่อยู่อาศัย</option>
                                                <option value="พืชผลทางการเกษตร,สัตว์เลี้ยง">พืชผลทางการเกษตร,สัตว์เลี้ยง</option>
                                            </select>
                                        </div>
                                        ...
                                        ?>
                                            <div class="col-md-4">
                                                <label class="mr-sm-2">ส่งให้พนักงานรวจ</label>
                                                <select name="REQ_DISA_EMP_ID" class="form-control" required>
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $res['m_id'] ?>"><?php echo $res['m_fname'] . ' ' . $res['m_name'] . ' ' . $res['m_lname'] ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <?php } else {
                                        ?>
                                            <input type="hidden" name="REQ_DISA_EMP_ID" value="<?php echo $_SESSION['m_id'] ?>">
                                        <?php
                                        } ?>
                                    ...
                                    <div class="tab-pane fade show active" id="buy" role="tabpanel">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <textarea name="REQ_DISA_DETAIL" id="REQ_DISA_DETAIL" class="form-control" placeholder="รายละเอียด" rows="4" cols="50"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input value="1" type="radio" name="REQ_DISA_PAY_TYPE" style="width: 20px;height:20px;"> &nbsp; &nbsp; &nbsp; รับเงินด้วยตัวเองที่ อผศ. &nbsp; &nbsp; &nbsp;

                                                <input value="2" type="radio" name="REQ_DISA_PAY_TYPE" style="width: 20px;height:20px;"> &nbsp; &nbsp; &nbsp; โอนเงินผ่านธนาคาร
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="radio" style="width: 20px;height:20px;" name="REQ_DST_LV" value="1">&nbsp; &nbsp; &nbsp;บางส่วน&nbsp; &nbsp; &nbsp;

                                                <input type="radio" style="width: 20px;height:20px;" name="REQ_DST_LV" value="2"> &nbsp; &nbsp; &nbsp;ทั้งหลัง
                                    ...
                                    <input type="hidden" name="vm_id" id="vm_id" value="<?php echo $_GET['id']; ?>">
