...
?>
					...
					<ul class="nav">
						...
						<?php if ($level == 'vsofficer' || $level == 'vsmanager') { ?>
							...
							<li class="has-sub active">
								...
								<ul class="sub-menu">
									<li class="active"><a href="view_disa_request.php">งานที่ต้องไปสำรวจ</a></li>
								...
								<table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
									...
									<tbody>
										...
										$sql = "SELECT *
											...
											WHERE 
											a.vm_id = b.m_id AND
											c.DST_ID = a.REQ_DST_ID AND 
											a.m_id <> 0 AND
											a.s_id=1 AND
											a.REQ_DISA_EMP_ID = $session_m_id";
										$db->Execute($sql);
										$i = 1;
										...
										?>
											<tr>
												...
												<td><button onclick="submit_form(<?php echo $res['REQ_DISA_ID'] ?>)" type="button" class="btn btn-primary">ดูรายละเอียด</button></td>
											</tr>
										<?php
											$i++;
										}
	...
	<script>
		function submit_form(id) {
			window.location = "assign_em_search_view_form.php?id=" + id
		}
	</script>
