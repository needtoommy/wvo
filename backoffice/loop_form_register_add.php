...
?>
        ...
        <div class="form-group row m-b-12">
            ...
            <div class="col-lg-2 col-xl-1">
                <input type="text" name="VT_FM_TITLE_ADD[<?php echo $i + 1 ?>]" placeholder="คำนำหน้าชื่อ" data-parsley-group="step-1" class="form-control" />
            </div>

            <label class="col-lg-1 text-lg-right col-form-label">ชื่อ <span class="text-danger">*</span></label>
            <div class="col-lg-2 col-xl-3">
                <input type="text" name="VT_FM_NAME_ADD[<?php echo $i + 1 ?>]" placeholder="ชื่อ" data-parsley-group="step-1" class="form-control" />
            </div>
            <label class="col-lg-1 text-lg-right col-form-label">นามสกุล <span class="text-danger">*</span></label>
            <div class="col-lg-2 col-xl-3">
                <input type="text" name="VT_FM_LNAME_ADD[<?php echo $i + 1 ?>]" placeholder="นามสกุล" data-parsley-group="step-1" class="form-control" />
            </div>
        </div>
        <div class="form-group row m-b-12">
            <label class="col-lg-2 text-lg-right col-form-label">วันเดือนปีเกิด <span class="text-danger">*</span></label>
            <div class="col-lg-2 col-xl-2">
                <input type="date" name="VT_FM_BRITH_DATE_ADD[<?php echo $i + 1 ?>]" data-parsley-group="step-1" class="form-control" />
            </div>

            <label class="col-lg-1 text-lg-right col-form-label">อายุ <span class="text-danger">*</span></label>
            <div class="col-lg-2 col-xl-2">
                <input type="number" name="VT_FM_AGE_ADD[<?php echo $i + 1 ?>]" placeholder="อายุ" data-parsley-group="step-1" class="form-control" />
            </div>
            <label class="col-lg-1 text-lg-right col-form-label">เกี่ยวข้องเป็น <span class="text-danger">*</span></label>
            <div class="col-lg-9 col-xl-3">
                <div class="row row-space-6">
                    <div class="col-7">
                        <select class="form-control" name="VT_FM_RELATION_ADD[<?php echo $i +1?>]">
        ...
        <div class="form-group row m-b-12">
            ...
            <div class="col-lg-2 col-xl-2">
                <select name="VT_SEX_ADD[<?php echo $i + 1 ?>]"  class="form-control">
            ...
            <div class="col-lg-2 col-xl-2">
                    <input type="text" name="VT_FM_IDCARD_ADD[<?php echo $i+1 ?>]"  class="form-control">
            </div>
        </div>
