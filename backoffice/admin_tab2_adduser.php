...
if ($_SESSION['PERMISSION'] == 'KORN') {
    ...
    if ($_POST['m_username']) {
        ...
        $sql = "INSERT INTO tbl_member (m_username,m_password,m_fname,m_name,m_lname,m_email,m_level,p_id) VALUES('$m_username', '$m_password', '$m_fname', '$m_name', '$m_lname', '$m_email', '$m_level', '$p_id')";
        $db->Execute($sql);
    }
                            ...
                            <div class="panel-body">
                                ...
                                <form action="#" method="POST">
                                    <div class="form-group row m-b-15">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control m-b-5" name="m_username" />
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-3">Password</label>
                                        <div class="col-md-9">
                                            <input type="text" name="m_password" class="form-control m-b-5" />
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-3">คำนำหน้า</label>
                                        <div class="col-md-9">
                                            <input type="text" name="m_fname" class="form-control m-b-5" />
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-3">ชื่อ</label>
                                        <div class="col-md-9">
                                            <input type="text" name="m_name" class="form-control m-b-5" />
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-3">นามสกุล</label>
                                        <div class="col-md-9">
                                            <input type="text" name="m_lname" class="form-control m-b-5" />
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-3">อีเมล</label>
                                        <div class="col-md-9">
                                            <input type="email" name="m_email" class="form-control m-b-5" />
                                        </div>
                                    </div>
            ...
            function submit() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        window.location = "admin_tab1_sub.php?id=" + $('#id').val()
                    }
                });
