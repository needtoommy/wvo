    ...
    <body>
                                            ...
                                            ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <!-- begin panel-body -->
                                                        <form action="death_form.php" method="POST" name="search">
                                                            <tr>
                                                                ...
                                                                <td> <?php echo number_format($res['REQ_DEATH_VALUE_APPROVE'],2)  ?></td>
                                                                <td>
                                                                    <button onclick="submit_order(<?php echo $res['m_id'] ?>)" type="submit" class="btn btn-danger">เลือก</button>
                                                                </td>
                                                            </tr>
                                                        </form>
                                                    <?php
        ...
        <script>
            ...
            function search() {
                ...
                window.location = "death_list.php?type=" + $('#type').val() + "&VT_CARD_STEP=" + $('#VT_CARD_STEP').val() + "&VT_CARD_NO=" + $('#VT_CARD_NO').val() + "&firstname=" + $('#firstname').val() + "&lastname=" + $('#lastname').val()
            }

            function submit_order(m_id) {

                window.location = "death_form.php?m_id=" + m_id
