                    ...
                    <div class="col-md-12">
                        <div class="panel panel-inverse">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="assign_em_search_db.php" method="post">
                                        ...
                                        ?>
                                            <div class="col-md-4">
                                                ...
                                                <select name="REQ_DISA_EMP_ID" class="form-control" required>
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $res_m['m_id'] ?>" <?php echo $res_m['m_id'] == $res['REQ_DISA_EMP_ID'] ? 'selected' : '' ?>><?php echo $res_m['m_fname'] . ' ' . $res['res_m'] . ' ' . $res_m['m_lname'] ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                    ...
                                    <div class="tab-pane fade show active" id="buy" role="tabpanel">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                ?>
                                                    <img width="300" src="../c_img/<?php echo $res['file_name'] ?>" alt="">
                                                <?php
                                                }
                                                ?>
                                            </div>
