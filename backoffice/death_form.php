                        ...
                        <div class="panel panel-inverse" data-sortable-id="ui-general-2">
                            ...
                            <form enctype="multipart/form-data" method="POST" name="search_form" id="search_form" action="death_form_db.php">
                                ...
                                if ($_SESSION['m_level'] == 'finoffice') {
                                    $sql = "SELECT * from req_death a, veteran b where  a.m_id = b.m_id and a.m_id =" . $_GET['m_id'] . "";
                                } else {
                                ...
                                <input type="hidden" name="m_id" id="m_id" value="<?php echo $_GET['m_id'] ?>">
                                <!-- begin step-1 -->
                                <div id="step-1">
                                    <!-- begin fieldset -->
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12 offset-xl-">
                                                ...
                                                <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">
                                                    <h3> &nbsp; &nbsp; &nbsp; &nbsp;บันทึกการสงเคราะห์กรณีถึงแก่ความตาย</h3>
                                                </legend>
                                                <hr>
                                                ...
                                                <div class="form-group row m-b-12">
                                                    ...
                                                    <div class="col-lg-2 col-xl-2">
                                                        <input type="number" name="REQ_DEATH_AGE" id="REQ_DEATH_AGE" value="<?php echo (date('Y') + 543) - explode("/", $res['VT_BRITH_DATE'])[2]; ?>" placeholder="อายุ" data-parsley-group="step-1" class="form-control" />
                                                    </div>
                                                    ...
                                                    <div class="col-lg-2 col-xl-2">
                                                        <input type="text" name="REQ_DEATH_DATE" id="REQ_DEATH_DATE" data-parsley-group="step-1" class="form-control" value="<?php echo $res['REQ_DEATH_DATE'] ?>" />
                                                    </div>
                                                        ...
                                                        <div class="row row-space-10">
                                                            <div class="col-12">
                                                                <select class="form-control" name="REQ_DEATH_TYPE" id="REQ_DEATH_TYPE">
                                                                    ...
                                                                    <option value="ชราภาพ" <?php echo $res['REQ_DEATH_TYPE'] == 'ชราภาพ' ? 'selected' : '' ?>>ชราภาพ</option>
                                                                    <option value="ชราภาพ" <?php echo $res['REQ_DEATH_TYPE'] == 'เจ็บป่วย' ? 'selected' : '' ?>>เจ็บป่วย</option>
                                                                    <option value="อุบัติเหตุ" <?php echo $res['REQ_DEATH_TYPE'] == 'อุบัติเหตุ' ? 'selected' : '' ?>>อุบัติเหตุ</option>
                                                                    <option value="ปฏิบัติหน้าที่" <?php echo $res['REQ_DEATH_TYPE'] == 'ปฏิบัติหน้าที่' ? 'selected' : '' ?>>ปฏิบัติหน้าที่</option>
                                                                    <option value="ชราภาพ" <?php echo $res['REQ_DEATH_TYPE'] == 'ชราภาพ' ? 'selected' : '' ?>>ชราภาพ</option>

                                                                    <option value="อื่นๆ" <?php echo $res['REQ_DEATH_TYPE'] == 'อื่นๆ' ? 'selected' : '' ?>>อื่นๆ</option>
                                                                </select>
                                                            </div>
                                                ...
                                                <div class="form-group row m-b-12">
                                                    ...
                                                    <div class="col-lg-2 col-xl-9">
                                                        <input type="text" name="REQ_DEATH_CAUSE" id="REQ_DEATH_CAUSE" placeholder="" data-parsley-group="step-1" class="form-control" value="<?php echo $res['REQ_DEATH_CAUSE'] ?>" />
                                                    </div>
                                                </div>
                                                <!-- end form-group -->
                                                ...
                                                <div class="form-group row m-b-12">
                                                    ...
                                                    <div class="col-lg-2 col-xl-9">
                                                        <input type="text" name="REQ_DEATH_EVIDENCE" id="REQ_DEATH_EVIDENCE" placeholder="" data-parsley-group="step-1" class="form-control" value="<?php echo $res['REQ_DEATH_EVIDENCE'] ?>" />
                                                    </div>
                                                </div>
                                                <!-- end form-group -->
                                                ...
                                                <div class="form-group row m-b-12">
                                                    ...
                                                    <div class="col-lg-2 col-xl-2">
                                                        <input type="text" name="REQ_DEATH_UDERTAKER" id="REQ_DEATH_UDERTAKER" placeholder="" data-parsley-group="step-1" class="form-control" value="<?php echo $res['REQ_DEATH_UDERTAKER'] ?>" />
                                                    </div>
                                                    <label class="col-lg-2 text-lg-right col-form-label">ความสัมพันธ์กับผู้เสียชีวิต<span class="text-danger">*</span></label>
                                                    <div class="col-lg-2 col-xl-2">
                                                        <input type="text" name="REQ_DEATH_REL" id="REQ_DEATH_REL" placeholder="" data-parsley-group="step-1" class="form-control" value="<?php echo $res['REQ_DEATH_REL'] ?>" />
                                                    </div>
                                                </div>
                                                <!-- end form-group -->
                                                ...
                                                <div class="form-group row m-b-12">
                                                    ...
                                                    <div class="col-lg-2 col-xl-2">
                                                        <input type="text" name="REQ_DEATH_PLACE" id="REQ_DEATH_PLACE" placeholder="" data-parsley-group="step-1" class="form-control" value="<?php echo $res['REQ_DEATH_PLACE'] ?>" />
                                                    </div>

                                                    <label class="col-lg-2 text-lg-right col-form-label">บำเพ็ญกุศล ณ<span class="text-danger">*</span></label>
                                                    <div class="col-lg-2 col-xl-2">
                                                        <input type="text" name="REQ_DEATH_MERIT_PLACE" id="REQ_DEATH_MERIT_PLACE" placeholder="" data-parsley-group="step-1" class="form-control" value="<?php echo $res['REQ_DEATH_MERIT_PLACE'] ?>" />
                                                    </div>
                                                    <label class="col-lg-1 text-lg-right col-form-label">เสียชีวิตที่จังหวัด<span class="text-danger">*</span></label>
                                                    <div class="col-lg-1 col-xl-2">
                                                        <input type="text" name="REQ_DEATH_PROVINCE" id="REQ_DEATH_PROVINCE" placeholder="" data-parsley-group="step-1" class="form-control" value="<?php echo $res['REQ_DEATH_PROVINCE'] ?>" />
                                                    </div>
                                                ...
                                                <?php
                                                if ($_SESSION['m_level'] == 'finoffice') {
                                                    $sql = "SELECT * from multi_file WHERE vs_id=7 AND m_id='" . $_GET['m_id'] . "'";
                                                    $db->Execute($sql);
                                                    $i = 1;
                                                ...
                                                ?>
                                                        <div class="form-group row m-b-12">
                                                            ...
                                                            <div class="col-lg-2 col-xl-2">
                                                                <img width="300" height="300" src="../c_img/<?php echo $res['file_name'] ?>" alt="">
                                                            </div>
                                                        </div>
                                ...
                                ?>
                                    <div class="col-md-12" style="justify-content:center; display:flex;">
                                        <button type="submit" class="btn btn-green" style="padding:10px;width:150px;margin-bottom:10px;">ยืนยันรายการ</button>
                                    </div>
                            ...
                            if ($_SESSION['m_level'] == "finoffice") {
                            ?>
                                <input type="hidden" name="type_finan" value="type_finan">
                                <div class="col-md-12" style="justify-content:center; display:flex;">
                                    <button type="submit" class="btn btn-green" style="padding:10px;width:150px;margin-bottom:10px;" onclick="cancel(5)">ยืนยันรายการ</button>&nbsp;&nbsp;&nbsp;
                                    <button type="submit" class="btn btn-danger" style="padding:10px;width:150px;margin-bottom:10px;" onclick="cancel(7)">ยกเลิกรายการ</button>
                                </div>
            ...
            const appv = (req_id, m_id, s_id, id) => {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        window.location = "death_list.php?type=9"
                    }
                });
            }

            function cancel(s_id) {
                $.ajax({
                    type: "POST",
                    url: "death_form_db.php",
                    data: {
                        type_finan: 'type_finan',
                        m_id: $('#m_id').val(),
                        s_id: s_id,
                    },
                    success: function(data) {
