...
if ($_SESSION['m_level'] == "vsofficer") {
    ...
    $sql = "UPDATE req_disa SET m_id='$m_id_manager',REQ_DISA_EMP_ID='$REQ_DISA_EMP_ID' WHERE REQ_DISA_ID='$REQ_DISA_ID'";
}
...
if ($success) {
    ...
    echo '
          ...
          $(document).ready(function(){
              ...
              setTimeout(function(){window.location="assign_em_search_add.php"}, 2000);
          });
          </script>
        ';
} else {
