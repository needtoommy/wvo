...
?>
    ...
    <head>
        ...
        <link href="../assets/plugins/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css" rel="stylesheet" />rel="stylesheet" />
                    ...
                    ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-inverse" data-sortable-id="ui-general-2">
                                ...
                                <!-- end panel-heading -->
                                <!-- begin panel-body -->
                                <form action="manage_status_db.php" method="post">
                                    <div class="panel-body">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $i ?></td>
                                                        <td>
                                                            <input type="text" class="form-control" name="s_name[<?php echo $i ?>]" value="<?php echo $res['s_name'] ?>">
                                                        </td>
                                                    </tr>
                                                <?php
                                                    $i++;
                                        ...
                                        <div style="text-align: center;">
                                            <button type="submit" class="btn btn-primary mt-3">อับเดตข้อมูล</button>
