                ...
                <div class="col-md-12">
                    <table id="data-table-fixed-columns" class="table table-striped table-bordered table-td-valign-middle" style="width:100%;">
                            ...
                            <tr>
                                ...
                                if ($_GET['status']) {
                                    if (($_GET['level'] == "vsofficer" || $_GET['level'] == "finoffice") && $_GET['type'] == 1) {
                                        $array_columns = array("เลขใบคำร้อง", "วันที่รับคำร้อง", "ชั้นบัตร", "เลขที่บัตร", "ชื่อ_สกุล", "รายละเอียดการเบิก", "จำนวนเงินขอเบิก", "จำนวนเงินอนุมัติ", "สถานะ");
                                    }

                                    if (($_GET['level'] == "vsofficer" || $_GET['level'] == "finoffice")  && $_GET['type'] == 2) {
                                        $array_columns = array("เลขใบคำร้อง", "วันที่รับคำร้อง", "ชั้นบัตร", "เลขที่บัตร", "ชื่อ_สกุล", "เหตุผลขอรับการสงเคราะห์", "จำนวนเงินขอเบิก", "จำนวนเงินอนุมัติ", "สถานะ");
                                    }

                                    if (($_GET['level'] == "vsofficer" || $_GET['level'] == "finoffice")  && $_GET['type'] == 3) {
                                        $array_columns = array("เลขใบคำร้อง", "วันที่รับคำร้อง", "ชั้นบัตร", "เลขที่บัตร", "ชื่อ_สกุล", "รายละเอียดการเบิก", "จำนวนเงินอนุมัติ", "สถานะ");
                                    }

                                    if (($_GET['level'] == "vsofficer" || $_GET['level'] == "finoffice")  && $_GET['type'] == 4) {
                                        $array_columns = array("เลขใบคำร้อง", "วันที่รับคำร้อง", "ชั้นบัตร", "เลขที่บัตร", "ชื่อ_สกุล", "ชื่อคู่สมรส",  "สถานะ");
                                    }

                                    if (($_GET['level'] == "vsofficer" || $_GET['level'] == "finoffice")  && $_GET['type'] == 5) {
                                        $array_columns = array("เลขใบคำร้อง", "วันที่รับคำร้อง", "ชื่อ_สกุล", "เบิกให้",  "ปีการศึกษา", "จำนวนเงินที่ขอเบิก", "สถานะ");
                                    }


                                    if (($_GET['level'] == "vsofficer" || $_GET['level'] == "finoffice")  && $_GET['type'] == 6) {
                                        $array_columns = array("เลขใบคำร้อง", "วันที่รับคำร้อง", "ชั้นบัตร", "เลขที่บัตร", "เลขบัตรประชาชน", "ชื่อ_สกุล", "สถานะ");
                                    }
                                } else {
                                    if (($_GET['level'] == "vsofficer" || $_GET['level'] == "finoffice") && $_GET['type'] == 1) {
                        ...
                        <tbody>
                            ...
                            //req_health case where status
                            if ($_GET['type'] == 1 && $_GET['status']) {
                                ...
                                WHERE  m.m_alive <> 0 and rh.s_id='$status'
                                ...
                                if (($_GET['level'] == "vsofficer" || $_GET['level'] == "vsmanger") && $_GET['type'] == 2) {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $array_rows['REQ_OCC_VALUE'] ?></td>
                                            <td><?php echo $array_rows['s_name'] ?></td>
                                            <td><a href='check_form_detail.php?REQ_OCC_ID=<?php echo $array_rows['REQ_OCC_ID'] ?>&type=2' class='btn btn-warning btn-xs'>ปรับสถานะ</a></td>
                            ...
                            if ($_GET['type'] == 3 && $_GET['status']) {
                                ...
                                WHERE   m.m_alive <> 0 AND rdisa.s_id='$status'
                                ...
                                while ($array_rows =  $db->getData()) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $array_rows['REQ_DISA_VALUE_APPROVE'] ?></td>
                                        <td><?php echo $array_rows['s_name'] ?></td>
                                    </tr>
                                    <?php
                                }
                            ...
                            ORDER BY rdisa.m_id DESC";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $array_rows['REQ_DISA_VALUE_APPROVE'] ?></td>
                                            <td><?php echo $array_rows['s_name'] ?></td>
                                            <td><a href='check_form_detail.php?REQ_DISA_ID=<?php echo $array_rows['REQ_DISA_ID'] ?>&type=3' class='btn btn-warning btn-xs'>ปรับสถานะ</a></td>
                                        </tr>
                                    <?php
                                    }
                                }
                            ...
                            if ($_GET['type'] == 4 && $_GET['status']) {
                                ...
                                WHERE rmat.s_id = '$status'
                                AND veteran_family.VT_FM_RELATION ='ภรรยา' and veteran.VT_ALIVE <>0 GROUP BY rmat.REQ_MAT_ID";
                                echo $sql;
                                $db->Execute($sql);
                                while ($array_rows =  $db->getData()) {
                                    ?>
                                ...
                                AND veteran_family.VT_FM_RELATION ='ภรรยา' and veteran.VT_ALIVE <>0 GROUP BY rmat.REQ_MAT_ID";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $array_rows["VT_FM_TITLE"] . $array_rows["VT_FM_NAME"] . ' ' . $array_rows["VT_FM_LNAME"] ?></td>
                                            <td><?php echo $array_rows['s_name'] ?></td>
                                            <td><a href='check_form_detail.php?REQ_MAT_ID=<?php echo $array_rows['REQ_MAT_ID'] ?>&type=4' class='btn btn-warning btn-xs'>ปรับสถานะ</a></td>
                                        </tr>
                                    <?php
                                    }
                                }
                              ...
                              AND veteran_family.VT_FM_RELATION ='บุตร' and veteran.VT_ALIVE <>0";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $array_rows['REQ_EDU_VALUE'] ?></td>
                                            <td><?php echo $array_rows['s_name'] ?></td>
                                            <td><a href='check_form_detail.php?REQ_EDU_ID=<?php echo $array_rows['REQ_EDU_ID'] ?>&type=5' class='btn btn-warning btn-xs'>ปรับสถานะ</a></td>
                                        </tr>
                                    <?php
                                    }
                                }
                            ...
                            if ($_GET['type'] == 6 && $_GET['status']) {
                                ...
                                INNER JOIN veteran ON veteran.m_id= m.m_id
                                WHERE rmonth.s_id = '$status' and veteran.VT_ALIVE <>0
                                ...
                                ORDER BY rmonth.REQ_MOTHLY_ID DESC";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="width:30%"><?php echo $array_rows["m_fname"] . $array_rows["m_name"] . ' ' . $array_rows["m_lname"] ?></td>
                                            <td><?php echo $array_rows['s_name'] ?></td>
                                            <td><a href='check_form_detail.php?REQ_MOTHLY_ID=<?php echo $array_rows['REQ_MOTHLY_ID'] ?>&type=6' class='btn btn-warning btn-xs'>ปรับสถานะ</a></td>
                                        </tr>
                                    <?php
                                    }
                                }
