                    ...
                    <thead>
                        <tr>
                            ...
                            if ($_GET['level'] == "vsofficer" && $_GET['type'] == 4) {
                                $array_columns = array("เลขใบคำร้อง", "วันที่รับคำร้อง", "ชื่อ_สกุล", "ชื่อคู่สมรส",  "สถานะ", "ปรับสถานะ");
                            }
                            ...
                            if ($_GET['level'] == "vsofficer" && $_GET['type'] == 6) {
                                $array_columns = array("เลขใบคำร้อง", "วันที่รับคำร้อง", "ชื่อ_สกุล", "สถานะ", "ปรับสถานะ");
                            }
