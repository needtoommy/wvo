    ...
    <body>
            ...
            <div id="header" class="header navbar-default">
                ...
                <div class="navbar-header">
                    <a href="index.html" class="navbar-brand"><span class="navbar-logo"></span>
                        ...
                        <b>ระบบสวัสดิการสงเคราะห์ทหารผ่านศึก</b> </a>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-inverse" data-sortable-id="ui-general-2">
                            ...
                            <div class="panel-body">
                                ...
                                <h3>เพิ่มพนักงาน</h3>
                                <?php echo $checksql; ?>
                                <form action="admin_tab1_adduser_db.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-3">Username</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control m-b-5" name="m_username" required />
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-3">Password</label>
                                        <div class="col-md-9">
                                            <input type="text" name="m_password" class="form-control m-b-5" required />
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-3">คำนำหน้า</label>
                                        <div class="col-md-9">
                                            <input type="text" name="m_fname" class="form-control m-b-5" required />
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-3">ชื่อ</label>
                                        <div class="col-md-9">
                                            <input type="text" name="m_name" class="form-control m-b-5" required />
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-3">นามสกุล</label>
                                        <div class="col-md-9">
                                            <input type="text" name="m_lname" class="form-control m-b-5" required />
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-3">รูปภาพ</label>
                                        <div class="col-md-9">
                                            <input type="file" name="m_img" class="form-control m-b-5" />
                                        </div>
                                    </div>
                                    <div class="form-group row m-b-15">
                                        <label class="col-form-label col-md-3">อีเมล</label>
                                        <div class="col-md-9">
                                            <input type="email" name="m_email" class="form-control m-b-5" required />
                                        </div>
                                    </div>
                                    ...
                                    <button style="display: inline-block;" type="submit" class="btn btn-primary">ยืนยัน</button>
        ...
        <script>
            ...
            function submit() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        swal('บันทึกเหตุผลสำเร็จ', '', 'success');
            ...
            function save_memo() {
                ...
                swal('บันทึกเหตุผลยกเลิกสำเร็จ', '', 'success');
            }
        </script>
