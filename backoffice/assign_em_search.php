                                    ...
                                    <div class="col-md-12">
                                        <table id="data-table-fixed-columns" class="table table-striped table-bordered table-td-valign-middle">
                                            ...
                                            <tbody>
                                                ...
                                                WHERE a.vm_id=b.m_id AND b.VT_ALIVE <>0
                                                 AND a.s_id=1 AND (a.REQ_DISA_EMP_ID<>0 OR a.vm_id<>0 ) AND a.m_id =0";
                                                $db->Execute($sql);
