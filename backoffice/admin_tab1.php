                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-inverse" data-sortable-id="ui-general-2">
                            ...
                            <div class="panel-body">
                                ...
                                <h3>รายการสมาชิก</h3>
                                <hr>
                                <h5>ระบุเงื่อนไขในการค้นหา</h5><br>
                                    ...
                                    <div class="row row-space-10">
                                        ...
                                        <div class="col-md-6" style="margin-bottom: 20px;">
                                            ...
                                            <option value="">ทั้งหมด</option>
                                                <?php
                                                $sql4 = "SELECT distinct(m_level) FROM tbl_member WHERE m_level <> 'member'";
                                                $db->Execute($sql4);
                                                while($res4 = $db->getData()){
                                                    ?>
                                                 
                                                    <option value="<?php echo $res4['m_level'] ?>"><?php echo $res4['m_level'] ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="col-md-12 mb-3" style="text-align:center;">
                                            ...
                                            <button type="button" onclick="adduser()" class="btn btn-success">เพิ่มบัญชีผู้ใช้</button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM tbl_member a, tbl_position b WHERE a.ref_p_id=b.p_id and a.m_role=1 and m_level <> 'member'";
                                        if ($_POST['date']) {
                                            $date = explode("-", $_POST['date']);
                                            $date = ($date[0] - 543) . "-" . $date[1] . "-" . $date[2];
                                            $sql .= " and a.m_datesave >= '$date'";
                                        }
                                        if ($_POST['dateto']) {
                                        ...
                                        if ($_POST['VT_FNAME']) {
                                            $sql .= " and a.m_name like '%" . trim($_POST['VT_FNAME']) . "%'";
                                        }
                                        if ($_POST['VT_LNAME']) {
                                            $sql .= " and a.m_lname like '%" . trim($_POST['VT_LNAME']) . "%'";
                                        }
                                        if($_POST['m_username']){
                                            $sql .= " and a.m_username like '%" . trim($_POST['m_username']) . "%'";
                                        }
                                        if($_POST['m_level']!=""){
                                            $sql .= " and a.m_level = '" . $_POST['m_level'] . "'";
                                        }
                                        //    echo $sql;
                                        $db->Execute($sql);
                                        $i = 1;
