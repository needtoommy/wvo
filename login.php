...
<body class="pace-top">
	...
	<div id="page-container" class="fade">
		...
		<div class="login login-with-news-feed">
			<!-- begin news-feed -->
			<div class="news-feed">
				<div class="news-image" style="background-image: url(assets/img/login-bg/demobgpic.jpg)"></div>
				...
				<div class="login-content">
					<form action="index.html" method="GET" class="margin-bottom-0">
						...
						<div class="login-buttons">
							<button type="submit" class="btn btn-success btn-block btn-lg">ลงชื่อเข้าใช้</button>
						</div>
